...
const PlaceCard: React.FC<PlaceCardProps> = ({ place, index, destination, travelDate }) => {
  ...
  return (
    <div className="group relative bg-[#1c1b1a] border border-white/10 hover:border-[#ff8c00]/50 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl">
      ...
      <div className="mt-auto flex flex-col border-t border-white/5 bg-black/20">
        {/* 컨트롤 패널 */}
        <div className="flex divide-x divide-white/5">
          ...
          <a 
            ...
            className="flex-1 flex items-center justify-center min-h-[48px] sm:min-h-[48px] hover:bg-[#ff8c00] text-white hover:text-black transition-all gap-2 active:bg-[#ff9d1a]"
          >
            <MapPin size={16} className="sm:w-3.5 sm:h-3.5" />
            <span className="text-[9px] sm:text-[8px] font-black uppercase tracking-widest">Open in Maps</span>
          </a>
        </div>
        <div className="w-full flex items-center justify-center border-t border-white/5 py-2">
